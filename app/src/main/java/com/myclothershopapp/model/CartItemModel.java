package com.myclothershopapp.model;
...
public class CartItemModel {
    ...
    /////////////// cart item start
      ...
      private boolean COD;
      private boolean isitMedicalProduct;
    ...
    public CartItemModel(boolean COD , int type, String productID, String productImage, String productTitle, Long freeCoupens, String productPrice, String cuttedPrice, Long productQuantity, Long offersApplied, Long coupensApplied, boolean inStock, Long maxQuantity, Long stockQuantity, Map<String,Long> qtymap,boolean isitMedicalProduct) {
        this.type = type;
        ...
        qtyError = false;
        this.COD = COD;
        this.isitMedicalProduct = isitMedicalProduct;
        this.hashmap = qtymap;
    }

    public boolean isIsitMedicalProduct() {
        return isitMedicalProduct;
    }

    public void setIsitMedicalProduct(boolean isitMedicalProduct) {
        this.isitMedicalProduct = isitMedicalProduct;
    }

    public Map<String, Long> getHashmap() {
        return hashmap;
    }

    public void setHashmap(Map<String, Long> hashmap) {
