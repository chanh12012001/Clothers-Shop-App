...
import com.myclothershopapp.adapter.MyRewardsAdapter;
import com.myclothershopapp.adapter.ProductDetailsAdapter;
import com.myclothershopapp.adapter.ProductImagesAdapter;
...
import static com.myclothershopapp.activities.Main2Activity.showCart;
import static com.myclothershopapp.activities.RegisterActivity.setSignUpFragment;
...
public class ProductDetailsActivity extends AppCompatActivity {
    ...
    private long productPriceColorPrivate = 0;
    private long productPricesizePrivate = 0;
    private static long realpriceproduct = 0;
    ...
    private String selectedcolorval,selectedcolorprice;
    private String selectedsizeval,selectedsizeprice;
    ...
    //////////////  PRODUCT VERIATIONS VERIABLES //////////////
    private Map<String, Long> pricemapveriations;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        selectSize.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialogTitle.setText("Select "+documentSnapshot.getString("size_title"));
                list = new ArrayList<>();

                if (list.size() == 0) {
                    for (int i = 0; i < sizeList.size(); i++) {
                        list.add(sizeList.get(i)+" ("+pricemapveriations.get(sizeList.get(i))+" đồng)");
                    }
                }
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (itssizedialog){
                    ...
                    radio.setCheckMarkDrawable(getResources().getDrawable(R.drawable.checkmark_selected, null));

                    sizeselected.setText(sizeList.get(i)+" ("+pricemapveriations.get(sizeList.get(i))+")");
                    selectedsizeval = sizeList.get(i);
                    selectedsizeprice = String.valueOf(pricemapveriations.get(sizeList.get(i)));
                    productPricesizePrivate = pricemapveriations.get(sizeList.get(i));
                    realpriceproduct = productPriceColorPrivate+productPricesizePrivate+ DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString());
                    productPrice.setText((productPriceColorPrivate+productPricesizePrivate+DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString()))+" đồng");
                    ...
                    CheckedTextView radio = (CheckedTextView) view.findViewById(R.id.checkedtextview);
                    radio.setCheckMarkDrawable(getResources().getDrawable(R.drawable.checkmark_selected, null));
                    colorSelected.setText(colorListarray.get(i)+" ("+pricemapveriations.get(colorListarray.get(i))+")");
                    productPriceColorPrivate = pricemapveriations.get(colorListarray.get(i));
                    realpriceproduct = productPriceColorPrivate+productPricesizePrivate+DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString());
                    productPrice.setText((productPriceColorPrivate+productPricesizePrivate+DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString()))+" đồng");

                    selectedcolorval = colorListarray.get(i);
                    selectedcolorprice = String.valueOf(pricemapveriations.get(colorListarray.get(i)));
                    adapter.notifyDataSetChanged();
                }
            }
        });
        ...
        selectColor.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                itssizedialog = false;
                TextView dialogTitle = selectSizeorColorDialog.findViewById(R.id.select_color_or_size);
                dialogTitle.setText("Select "+documentSnapshot.getString("color_title"));

                colorlist = new ArrayList<>();
                if (colorlist.size() == 0) {
                    for (int i = 0; i < colorListarray.size(); i++) {
                        colorlist.add(colorListarray.get(i)+" ("+pricemapveriations.get(colorListarray.get(i))+")");
                    }
                }
                            ...
                            .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                                ...
                                public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        totalRatingMiniView.setText("(" + (long) documentSnapshot.get("total_rating") + ") đánh giá");
                                        productPrice.setText(DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString()) + " đồng");
                                        ...
                                        pricemapveriations =(Map<String, Long>) documentSnapshot.get("attributsallcolorandsize");

                                        ///////////////for coupen dialog
                                        originalPrice.setText(DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString()) + "đồng");
                                        productOriginalPrice = String.valueOf(DBqueries.getproductPrice(ProductDetailsActivity.this,documentSnapshot.get("product_price").toString()));
                                       ...
                                       DBqueries.setCuttedPrice(cuttedPrice,ProductDetailsActivity.this,documentSnapshot.get("product_price").toString());
                                        ...
                                        totalRatings.setText((long) documentSnapshot.get("total_rating") + " đánh giá");
                                                    ...
                                                    if (currentuser == null) {
                                                        ...
                                                        if (!running_cart_query) {
                                                            ...
                                                            if (ALREADY_ADDED_TO_CART) {
                                                                ...
                                                                DynamicToast.make(ProductDetailsActivity.this, "Already added to cart.", Toast.LENGTH_SHORT).show();
                                                            } else {
                                                                ...
                                                                firebaseFirestore.collection("USERS").document(currentuser.getUid()).collection("USER_DATA").document("MY_CART")
                                                                    ...
                                                                    public void onComplete(@NonNull Task<Void> task) {
                                                                        if (task.isSuccessful()) {
                                                                            ...
                                                                            DynamicToast.make(ProductDetailsActivity.this, "Đã thêm vào gio hàng", Toast.LENGTH_SHORT).show();
                                                                            invalidateOptionsMenu();
                                                                            running_cart_query = false;
                                                                        } else {
                                                                            running_cart_query = false;
                                                                            String error = task.getException().getMessage();
                                                                            DynamicToast.make(ProductDetailsActivity.this, error, Toast.LENGTH_SHORT).show();
                                                                        }
                                                                    }
                                                                });
                            ...
                            firebaseFirestore.collection("USERS").document(currentuser.getUid()).collection("USER_DATA").document("MY_WISHLIST")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        DynamicToast.make(ProductDetailsActivity.this, "Đã thêm vào danh sách yêu thích.", Toast.LENGTH_SHORT).show();
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if (task.isSuccessful()) {
                                                        ...
                                                        if (DBqueries.myRatedIds.contains(productID)) {
                                                            ...
                                                            DynamicToast.make(ProductDetailsActivity.this, "Cảm ơn đã đánh giá.", Toast.LENGTH_SHORT).show();
                                                        }
