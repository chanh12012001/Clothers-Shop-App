...
public class AddAddressActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Thêm một địa chỉ mới");
                            ...
                            if (!TextUtils.isEmpty(pincode.getText()) && pincode.getText().length() == 6) {
                                if (!TextUtils.isEmpty(name.getText())) {
                                    if (!TextUtils.isEmpty(mobileNo.getText()) && mobileNo.getText().length() == 10) {
                                        ...
                                        FirebaseFirestore.getInstance().collection("USERS")
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    DynamicToast.make(AddAddressActivity.this, error, Toast.LENGTH_SHORT).show();
                                                }
                                        ...
                                        DynamicToast.make(AddAddressActivity.this, "Vui lòng cung cấp Số điện thoại di động hợp lệ .", Toast.LENGTH_SHORT).show();
                                    }
                                } else {
                                    name.requestFocus();
                                }
                                ...
                                DynamicToast.make(AddAddressActivity.this, "Vui lòng cung cấp mã pin hợp lệ.", Toast.LENGTH_SHORT).show();
                            }
                        } else {
