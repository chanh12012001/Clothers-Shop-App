...
import com.myclothershopapp.adapter.GridProductLayoutAdapter;
import com.myclothershopapp.model.HorizontalProductScrollModel;
import com.myclothershopapp.R;
import com.myclothershopapp.adapter.WishlistAdapter;
...
public class ViewAllActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (layout_code == 0) {
            ...
            GridProductLayoutAdapter gridProductLayoutAdapter = new GridProductLayoutAdapter(horizontalProductScrollModelList,ViewAllActivity.this);
