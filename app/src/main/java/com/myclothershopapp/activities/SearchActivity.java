...
public class SearchActivity extends AppCompatActivity {
                        ...
                        public void onComplete(@NonNull Task<QuerySnapshot> task) {
                            if (task.isSuccessful()){
                               ...
                               String error = task.getException().getMessage();
                                DynamicToast.make(SearchActivity.this, error, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
                }
    ...
    public void btnspeech(View view) {
        ...
        try {
            ...
            DynamicToast.make(this, "DElate" ,Toast.LENGTH_SHORT).show();
        }
    }
    ...
    class Adapter extends WishlistAdapter implements Filterable {
        ...
        public Adapter(List<WishlistModel> wishlistModelList, Boolean wishlist) {
            super(wishlistModelList, wishlist,SearchActivity.this);
