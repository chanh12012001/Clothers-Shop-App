                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            ProductDetailsActivity.ALREADY_ADDED_TO_WISHLIST=false;
                            Toast.makeText(context,"Đã xóa khỏi sach sách yêu thích!",Toast.LENGTH_SHORT).show();
                        } else {
                            if(ProductDetailsActivity.addToWishlistBtn != null) {
                                ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.colorPrimaryDark));
                            }
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            for (DocumentSnapshot orderItems : task.getResult().getDocuments()) {
                                                                ...
                                                                MyOrderItemModel myOrderItemModel = new MyOrderItemModel(
                                                                        ...
                                                                        , (Date) orderItems.getTimestamp("Ordered Date").toDate()
                                                                        , (Date) orderItems.getTimestamp("Packed Date").toDate()
                                                                        , (Date) orderItems.getTimestamp("Shipped Date").toDate()
                                                                        , (Date) orderItems.getTimestamp("Delivered Date").toDate()
                                                                        , (Date) orderItems.getTimestamp("Cancelled Date").toDate()
