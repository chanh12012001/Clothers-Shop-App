...
public class DeliveryActivity extends AppCompatActivity {
    ...
    private ImageButton cod, continueShoppingBtn;
                                    ...
                                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                                        ...
                                        public void onComplete(@NonNull Task<Void> task) {
                                            if(task.isSuccessful()){
                                                ...
                                                Toasty.warning(DeliveryActivity.this, "Failed to update user orders list !", Toast.LENGTH_LONG,true).show();
                                            }
                                        }
                                    });
                        }else {
                            Toasty.error(DeliveryActivity.this, "Order Cancelled !", Toast.LENGTH_LONG,true).show();
                        }
                    }
                });
