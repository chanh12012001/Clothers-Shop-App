...
import com.myclothershopapp.activities.MyAddressesActivity;
import com.myclothershopapp.activities.RegisterActivity;
import com.myclothershopapp.activities.UpdateUserInfoActivity;
...
public class MyAccountFragment extends Fragment {
            ...
            public void onDismiss(DialogInterface dialog) {
                for (MyOrderMainModel orderItemModel : DBqueries.myOrderMainItemModelList){
                        if (!orderItemModel.getOrderStatus().equals("Delivered") && !orderItemModel.getOrderStatus().equals("Cancelled")){
                            ...
                            totalammount.setText("Tổng thanh toán: "+ orderItemModel.getTotalAmmount()+ " đồng");
    ...
    public void onStart() {
        ...
        if (!DBqueries.profile.equals("")){
            Glide.with(getContext()).load(DBqueries.profile).apply(new RequestOptions().placeholder(R.drawable.profile_icon)).into(profileView);
        }else {
